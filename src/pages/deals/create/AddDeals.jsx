            ...
            <form action="" onSubmit={handleSubmit}>
              ...
              {showAdditionalFields && (
                <>
                  ...
                  <div className="mb-4">
                    <label htmlFor="pan_no" className="block text-dark text-sm font-semibold mb-2">
                      PAN Number
                    </label>
                    <input
                      type="text"
              ...
              <div className="mb-4">
                <label htmlFor="segment_id" className="block text-dark text-sm font-semibold mb-2">
