...
function AddEmployee({ show, onClose, onSave }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (errors.length > 0) {
      ...
      // Axios POST request
      axios
        .post('http://localhost:3001/addemployees', employee)
        .then((response) => {
        ...
        <NavbarSidebarLayout isFooter={false}>
          <div className="emp_container">
              <form className="emp_form" action="" onSubmit={handleSubmit}>
                <h2 className="h2_class text-3xl text-center  font-bold mb-6">Add Employee</h2>
