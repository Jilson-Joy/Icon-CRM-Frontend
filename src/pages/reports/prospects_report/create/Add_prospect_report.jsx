...
import './Add_prospect_report.css';
// import prospects_report from '../../../../constants/json/prospects_report.json';
// import useProspectReport from '../../../../hooks/useProspectReport'
import useAxios from '../../../../hooks/useAxios/useAxios';
function Add_prospect_report() {
  // const {GetuseProspectReport}=useProspectReport();
  // const [prospectReportData, setProspectReportData] = useState([]);
  const { response, error, loading } = useAxios({
    method: 'GET',
    url: 'http://localhost:3010/prospect' // Update URL with correct endpoint
  });
  ...
  return (
    <NavbarSidebarLayout isFooter={false}>
      <div className="salesCall_report_container">
        <h2 className="salesCall_report_header">Prospect Report</h2>
              ...
              <tbody>
                {filteredSalesCall.map((salesData, index) => (
                  <tr
                    ...
                    <td className="px-3 py-3 text-center">{salesData.fleet}▼</td>
                    <td
...
export default Add_prospect_report;
