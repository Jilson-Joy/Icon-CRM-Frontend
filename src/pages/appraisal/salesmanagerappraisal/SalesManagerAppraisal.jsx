...
import './SalesManagerAppraisal.css'

function SalesManagerAppraisal() {
  return (
    <NavbarSidebarLayout isFooter={false}>
      <div className="Appraisaltable2">
          ...
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg mb-5 block">
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              <thead className="appraisal_thead text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr className="border-b border-gray-600" style={{ height: '70px' }}>
              ...
              <tbody>
                <tr className="row_2_manager border-b border-gray-600  text-xs text-gray-700 uppercase dark:text-gray-400 bg-gray-50">
                ...
                <tr className="row_3_manager bg-white  border-b uppercase dark:bg-gray-800 dark:border-gray-700 ">
                  <td className="appraisal_row_1  px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600">
                    Sl No
                  </td>
                  <td className="appraisal_row_1  px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600">
                    Description
                  ...
                  <td
                    colSpan={6}
                    className="appraisal_row_1  px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white ">
                    Achievement %
                  </td>
                </tr>
                ...
                <tr className="bg-white  border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td className="appraisal_row_1  px-6 py-4 uppercase font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600">
                ...
                <tr className="total_row_manager bg-white  border-b dark:bg-gray-800 dark:border-gray-700 ">
                  <td className="appraisal_row px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600">
                    
                  </td>
                  <td className="appraisal_row_1  px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white ">
                    Total Score
                  </td>
                ...
                <tr className="bg-white  border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td className="appraisal_row px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600">
                    Customer Visit With Service Team
                  </td>
                  <td className="appraisal_row px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600">
                    {' '}
                  </td>
                ...
                <tr className="total_row_manager bg-white uppercase border-b dark:bg-gray-800 dark:border-gray-700 ">
                  <td className="appraisal_row px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600"></td>
                  <td className="appraisal_row_1  px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white ">
                    Total Score
                  </td>
                ...
                <tr className="apprasial_eligible_manager  text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                ...
                <tr className="bg-white uppercase border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <td className="appraisal_row_1  px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600">
                    Sl No
                  </td>
                  <td className="appraisal_row_1  px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600">
                ...
                <tr className="bg-white  border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td  colSpan={6} className="appraisal_row px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white ">
                    Total Incentive
                  </td>
                </tr>
                ...
                <tr className="total_row_manager bg-white uppercase border-b dark:bg-gray-800 dark:border-gray-700 ">
                  ...
                  <td
                    className="appraisal_row_1  px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600"
                    colSpan={3}>
                    Total
                  </td>
...
export default SalesManagerAppraisal;
