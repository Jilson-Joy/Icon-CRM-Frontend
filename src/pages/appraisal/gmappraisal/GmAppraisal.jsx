...
import './GmAppraisal.css';

function GmAppraisal() {
  return (
    <NavbarSidebarLayout isFooter={false}>
      <div className="Appraisaltable3">
        <div className="appraisal_table">
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg mb-5 block">
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr
                  className="row_2_gm border-b border-gray-600  text-xs text-gray-700 uppercase dark:text-gray-400 bg-gray-50"
                 >
                ...
                <tr className="row_3_gm  bg-white  border-b dark:bg-gray-800 dark:border-gray-700 ">
                  ...
                  <td colSpan={3} className="appraisal_row_1   uppercase px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white ">
                    Achievement %
                  </td>
                </tr>
                ...
                <tr className="bg-white  border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td className="appraisal_row px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600"></td>
                  <td colSpan={3} className="appraisal_row px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white "></td>
                </tr>
                ...
                <tr className="bg-white  border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td colSpan={3} className="appraisal_row px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white ">
                    87.5
                  </td>
                </tr>
                ...
                <tr className="total_row_gm  bg-white  border-b dark:bg-gray-800 dark:border-gray-700 ">
                  <td className="appraisal_row px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white border-r border-gray-600">
                ...
                <tr className=" apprasial_eligible_gm  text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                ...
                <tr className="row_3_gm   bg-white  border-b dark:bg-gray-800 dark:border-gray-700 ">
                  ...
                  <td colSpan={6} className="appraisal_row_1 uppercase px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white ">
                    Total Incentive
                  </td>
                </tr>
